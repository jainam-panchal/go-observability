...
func TestDefaultConfig(t *testing.T) {
	...
	if cfg.RuntimeMetrics != defaultRuntimeMetrics {
		t.Fatalf("RuntimeMetrics = %v, want %v", cfg.RuntimeMetrics, defaultRuntimeMetrics)
	}
...
func TestLoadConfigFromEnv(t *testing.T) {
	...
	t.Setenv("OTEL_RUNTIME_METRICS_ENABLED", "false")
	...
	if cfg.RuntimeMetrics {
		t.Fatal("RuntimeMetrics = true, want false")
	}
...
func TestLoadConfigFromEnvFallsBackForInvalidValues(t *testing.T) {
	...
	t.Setenv("OTEL_RUNTIME_METRICS_ENABLED", "not-a-bool")
